...
ax[0].plot(np.arange(N_simul), y_path, label = 'income', lw = 2, color = sb.color_palette()[3], alpha = .6, linestyle = '--')
...
ax[1].plot(np.arange(N_simul), y_path, label = 'income', lw = 2, color = sb.color_palette()[3],
           alpha = .6, linestyle = '--')
