...
function AMF_LSS_VAR(A::Real, B::Real, D::Real, F::Real=0.0, nu::Real=0.0)
    # Construct BIG state space representation
    lss = construct_ss(A,B,D,F,nu)
    return AMF_LSS_VAR(A,B,D,F,nu,lss)
end
...
"""
function construct_ss(A::Real, B::Real, D::Real, F::Real, nu::Real)
...
"""
function multiplicative_decomp(A::Real, B::Real, D::Real, F::Real, nu::Real)
    H, g = additive_decomp(A, B, D, F)
    nu_tilde = nu + 0.5*H^2
